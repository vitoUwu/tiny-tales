export default function TOS() {
  return (
    <p>
      TERMS OF SERVICELast updated April 24, 2023AGREEMENT TO OUR LEGAL TERMSWe
      are Tiny Tales (Company, we, us, our), a company registered in Brazil at
      __________, __________.We operate the website
      https://tiny-tales.vercel.app (the Site), as well as any other related
      products and services that refer or link to these legal terms (the Legal
      Terms) (collectively, the Services).You can contact us by phone at
      +5567998773005, email at victorhugomeurerdelgrandi@gmail.com, or by mail
      to __________, __________,Brazil.These Legal Terms constitute a legally
      binding agreement made between you, whether personally or on behalf of an
      entity (you), and Tiny Tales, concerning your access to and use of the
      ...
      such revised Legal Terms are posted.The Services are intended for users
      ...
      your records.TABLE OF CONTENTS1. OUR SERVICES2. INTELLECTUAL PROPERTY
      RIGHTS3. USER REPRESENTATIONS4. USER REGISTRATION 5. PROHIBITED ACTIVITIES
      6. USER GENERATED CONTRIBUTIONS 7. CONTRIBUTION LICENSE 8. GUIDELINES FOR
      REVIEWS 9. SOCIAL MEDIA 10. SERVICES MANAGEMENT 11. PRIVACY POLICY 12.
      COPYRIGHT INFRINGEMENTS 13. TERM AND TERMINATION 14. MODIFICATIONS AND
      INTERRUPTIONS 15. GOVERNING LAW 16. DISPUTE RESOLUTION 17. CORRECTIONS 18.
      DISCLAIMER 19. LIMITATIONS OF LIABILITY 20. INDEMNIFICATION 21. USER DATA
      22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 23. CALIFORNIA
      USERS AND RESIDENTS 24. MISCELLANEOUS 25. CONTACT US1. OUR SERVICESThe
      ...
      extent local laws are applicable.The Services are not tailored to comply
      ...
      would violate the Gramm-Leach-Bliley Act (GLBA).2. INTELLECTUAL PROPERTY
      RIGHTSOur intellectual propertyWe are the owner or the licensee of all
      ...
      internal business purpose.Except as set out in this section or elsewhere
      ...
      victorhugomeurerdelgrandi@gmail.com. If we ever grant you the permission
      ...
      Content.We reserve all rights not expressly granted to you in and to the
      Services, Content, and Marks.Any breach of these Intellectual Property
      Rights will constitute a material breach of our Legal Terms and your right
      to use our Services will terminate immediately.Your submissions and
      contributionsPlease review this section and the PROHIBITED ACTIVITIES
      ...
      users of the Services.When you post Contributions, you grant us a license
      ...
      and to sublicense the licenses granted in this section. Our use and
      distribution may occur in any media formats and through any media
      channels.This license includes our use of your name, company name, and
      ...
      Contribution;• warrant that any such Submission and/or Contributions are
      ...
      Submissions and/or Contributions; and• warrant and represent that your
      ...
      any third party’s intellectual property rights, or (c) applicable law.We
      ...
      your account and report you to the authorities.Copyright infringementWe
      ...
      INFRINGEMENTS section below.3. USER REPRESENTATIONSBy using the Services,
      ...
      Services will not violate any applicable law or regulation.If you provide
      any information that is untrue, inaccurate, not current, or incomplete, we
      ...
      REGISTRATIONYou may be required to register to use the Services. You agree
      to keep your password confidential and will be responsible for all use of
      ...
      objectionable.5.PROHIBITED ACTIVITIESYou may not access or use the
      ...
      a user of the Services, you agree not to: • Systematically retrieve data
      ...
      operation, or maintenance of the Services.• Engage in any automated use of
      ...
      interchange formats (gifs), web bugs, cookies, or other similar devices
      (sometimes referred to as spyware or passive collection mechanisms or
      pcms).• Interfere with, disrupt, or create an undue burden on the Services
      ...
      otherwise transfer your profile.6. USER GENERATED CONTRIBUTIONSThe
      ...
      on the Services, including but not limited to text, writings, video,
      ...
      violence against a specific person or class of people.• Your Contributions
      ...
      party.• Your Contributions do not violate any applicable law concerning
      ...
      Services.7. CONTRIBUTION LICENSEBy posting your Contributions to any part
      ...
      media formats and through any media channels.This license will apply to
      ...
      applicable, and any of the trademarks, service marks, trade names, logos,
      and personal and commercial images you provide. You waive all moral rights
      in your Contributions, and you warrant that moral rights have not
      ...
      obligation to monitor your Contributions.8. GUIDELINES FOR REVIEWSWe may
      ...
      or negative.We may accept, reject, or remove reviews in our sole
      ...
      content relating to review.9. SOCIAL MEDIAAs part of the functionality of
      the Services, you may link your account with online accounts you have with
      ...
      govern your use of each Third-Party Account. You represent and warrant
      ...
      account.10. SERVICES MANAGEMENTWe reserve the right, but not the
      ...
      Services.11. PRIVACY POLICYWe care about data privacy and security. Please
      review our Privacy
      Policy: https://www.privacypolicytemplate.net/live.php?token=vt2x75ymeysdtbwvio2l0d797mkoup99.
      ...
      reasonably practical.12. COPYRIGHT INFRINGEMENTSWe respect the
      intellectual property rights of others. If you believe that any material
      available on or through the Services infringes upon any copyright you own
      ...
      contacting an attorney.13. TERM AND TERMINATIONThese Legal Terms shall
      ...
      criminal, and injunctive redress.14. MODIFICATIONS AND INTERRUPTIONSWe
      ...
      Services.We cannot guarantee the Services will be available at all times.
      ...
      or releases in connection therewith.15. GOVERNING LAWThese Legal Terms
      shall be governed by and defined following the laws of Brazil. Tiny Tales
      and yourself irrevocably consent that the courts of Brazil shall have
      exclusive jurisdiction to resolve any dispute which may arise in
      connection with these Legal Terms.16. DISPUTE RESOLUTIONYou agree to
      ...
      Brazil courts. Tiny Tales shall also maintain the right to bring
      proceedings as to the substance of the matter in the courts of the country
      where you reside or, if these Legal Terms are entered into in the course
      of your trade or profession, the state of your principal place of
      business.17. CORRECTIONSThere may be information on the Services that
      ...
      change or update the information on the Services at any time, without
      prior notice.18. DISCLAIMERTHE SERVICES ARE PROVIDED ON AN AS-IS AND
      ...
      MOBILE APPLICATIONS LINKED TO THE SERVICES AND WE WILL ASSUME NO LIABILITY
      ...
      LIABILITYIN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE
      ...
      DAMAGES. 20. INDEMNIFICATIONYou agree to defend, indemnify, and hold us
      ...
      your Contributions; (2) use of the Services; (3) breach of these Legal
      Terms; (4) any breach of your representations and warranties set forth in
      these Legal Terms; (5) your violation of the rights of a third party,
      ...
      it.21. USER DATAWe will maintain certain data that you transmit to the
      Services for the purpose of managing the performance of the Services, as
      well as data relating to your use of the Services. Although we perform
      ...
      using the Services. You agree that we shall have no liability to you for
      ...
      data.22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURESVisiting
      ...
      any means other than electronic means.23. CALIFORNIA USERS AND RESIDENTSIf
      ...
      952-5210 or (916) 445-1254.24. MISCELLANEOUSThese Legal Terms and any
      ...
      parties hereto to execute these Legal Terms.25. CONTACT USIn order to
      resolve a complaint regarding the Services or to receive further
      information regarding use of the Services, please contact us at:Tiny
      Tales__________Brazilvictorhugomeurerdelgrandi@gmail.com
    </p>
  );
}
